...
public class Assignment2 {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.findElement(By.linkText("Edit")).click();				// click edit button using linktext
		Pagetitle = driver.getTitle();// Get page title for the result page
		
		System.out.println("Edit page :"+Pagetitle);
		driver.findElement(By.id("updateLeadForm_description")).clear();// Clear description field
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("This is update process");// Input in important note
		driver.findElement(By.className("smallSubmit")).click();
